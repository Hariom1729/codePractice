...
import { 
  ...
  GitCommit, Search, TextSelect, Boxes, Link2, Route, Spline, Blocks
} from 'lucide-react';
...
export default async function LearningHub() {
  ...
  const topics = [
    ...
    { id: 'queues', title: 'Queues', icon: ArrowRightLeft, difficulty: 'Beginner', time: '2 hours', lessons: 6, progress: 60, color: '--color-accent-blue' },
    { id: 'hash-tables', title: 'Hash Tables', icon: Hash, difficulty: 'Beginner', time: '4 hours', lessons: 14, progress: 0, color: '--color-accent-blue' },
    { id: 'two-pointers', title: 'Two Pointers', icon: GitCommit, difficulty: 'Beginner', time: '5 hours', lessons: 12, progress: 0, color: '--color-accent-blue' },
    { id: 'binary-search', title: 'Binary Search', icon: Search, difficulty: 'Beginner', time: '4 hours', lessons: 10, progress: 0, color: '--color-accent-blue' },
    ...
    { id: 'mst', title: 'MST Algorithms', icon: Spline, difficulty: 'Advanced', time: '6 hours', lessons: 12, progress: 0, color: '--color-accent-violet' },
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 w-full mt-4 relative z-10">
        ...
        <FadeIn delay={0.5} className="mb-8 flex items-center justify-between">
          ...
          <div className="flex gap-2 text-sm font-medium">
            <span className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-full bg-green-400"></div> Beginner</span>
            <span className="flex items-center gap-1.5 ml-3"><div className="w-2.5 h-2.5 rounded-full bg-yellow-400"></div> Intermediate</span>
            <span className="flex items-center gap-1.5 ml-3"><div className="w-2.5 h-2.5 rounded-full bg-red-400"></div> Advanced</span>
          </div>
        </FadeIn>
